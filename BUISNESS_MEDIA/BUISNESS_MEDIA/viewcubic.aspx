<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewcubic.aspx.cs" Inherits="BUISNESS_MEDIA.viewcubic" %>
        ...
        <div class="row display-table-row">
            <div class="col-md-1 col-sm-1 hidden-xs display-table1-cell v-align box" id="navigation">
               ...
               <div class="navi">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="viewcubic.aspx"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">office-Home</span></a></li>
                        <li ><a href="work.aspx"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">WORK</span></a></li>
