<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="BUISNESS_MEDIA.Update" %>
                        ...
                        <form id="form2" runat="server" class="register-form">
                            ...
                            <div class="form-group">  
                             ...
                             <div class="form-group">  
                              ...
                              <div class="form-group"> 
                              <asp:FileUpload ID="imgUpload" runat="server" onchange="upload_Click"  />
                                <asp:Label ID="lblResult" runat="server" ForeColor="#0066FF"></asp:Label>
                                <asp:Button ID="Button1" runat="server"  class="form-submit" Text="upload"  OnClick="upload_Click"/>
                            ...
                            <div class="form-group form-button">
                                <asp:Button ID="Register" runat="server"  class="form-submit" Text="update" OnClientClick="return check()" OnClick="input_Click"/>
                            </div>
                        </form>
                    </div>
